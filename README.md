...
Auth is a Laravel package to quickly implement the authentication system into your applications, avoiding you to implement it every time you start a new project and letting you customize every single aspect of such process.
